  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td><a href="../WorldList/India.html"><button>인도 (India)</button></a></td>
      ...
      <tr>
        ...
        <td><a href="../WorldList/China.html"><button>중국 (China)</button></a></td>
      ...
      <tr>
        ...
        <td><a href="../WorldList/USA.html"><button>미국 (USA)</button></a></td>
      ...
      <tr>
        ...
        <td><a href="../WorldList/Indonesia.html"><button>인도네시아 (Indonesia)</button></a></td>
      ...
      <tr>
        ...
        <td><a href="../WorldList/Brazil.html"><button>브라질 (Brazil)</button></a></td>
      ...
      <tr>
        ...
        <td><a href="../WorldList/Russia.html"><button>러시아 (Russia)</button></a></td>
      ...
      <tr>
        ...
        <td><a href="../WorldList/Mexico.html"><button>멕시코 (Mexico)</button></a></td>
      ...
      <tr>
        ...
        <td><a href="../WorldList/Japan.html"><button>일본 (Japan)</button></a></td>
      ...
      <tr>
        ...
        <td><a href="../WorldList/Turkey.html"><button>튀르키예 (Turkey)</button></a></td>
      ...
      <tr>
        ...
        <td><a href="../WorldList/Germany.html"><button>독일 (Germany)</button></a></td>
      ...
      <tr>
        ...
        <td><a href="../WorldList/UK.html"><button>영국 (UK)</button></a></td>
      ...
      <tr>
        ...
        <td><a href="../WorldList/France.html"><button>프랑스 (France)</button></a></td>
      ...
      <tr>
        ...
        <td><a href="../WorldList/Italy.html"><button>이탈리아 (Italy)</button></a></td>
      ...
      <tr>
        ...
        <td><a href="../WorldList/South_Korea.html"><button>대한민국 (Korea)</button></a></td>
      ...
      <tr>
        ...
        <td><a href="../WorldList/Spain.html"><button>스페인 (Spain)</button></a></td>
      ...
      <tr>
        ...
        <td><a href="../WorldList/Canada.html"><button>캐나다 (Canada)</button></a></td>
      ...
      <tr>
        ...
        <td><a href="../WorldList/Saudi_Arabia.html"><button>사우디 아라비아(Saudi arabia)</button></a></td>
      ...
      <tr>
        ...
        <td><a href="../WorldList/Australia.html"><button>호주 (Australia)</button></a></td>
      ...
      <tr>
        ...
        <td><a href="../WorldList/Netherlands.html"><button>네덜란드 (Netherlands)</button></a></td>
      ...
      <tr>
        ...
        <td><a href="../WorldList/Switzerland.html"><button>스위스 (Switzerland)</button></a></td>
